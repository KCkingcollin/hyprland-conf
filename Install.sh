...
then
    ...
    then
        ...
        cd "/home/$accountName"
        sudo -S -i -u $accountName git clone -b v0.0.2 https://github.com/KCkingcollin/kcs-reasonable-configs
...
then
    ...
    git clone -b v0.0.2 https://github.com/KCkingcollin/kcs-reasonable-configs
